---
title: "从原始仓库获取更改"
description: "使用 git fetch 获取远程提交而不修改当前分支。"
type: tutorial
group: "基础篇"
sidebar:
  order: 28
...
我们在 `git_learning` 仓库根目录添加 README.md，写入一行 `Git Learning`，然后提交。
...
Path
----
C:\Users\aku\Desktop\cloned_git_learning
...
* 2456c71 2023-05-05 | Added test2.txt (HEAD -> master, origin/lgnew) [aku]
...
现在看一下 `Added test2.txt` 提交。你会发现本地主分支指向这个提交，而不是刚刚获取的新提交。
