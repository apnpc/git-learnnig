---
title: "托管 Git 仓库"
description: "以只读方式运行 Git Daemon，并说明匿名协议的安全边界。"
type: how-to
group: "基础篇"
sidebar:
  order: 35
...
设置 Git 守护进程（Git Daemon）以只读方式共享 Git 仓库。

> Git 协议没有认证和加密。不要在不可信网络中暴露服务，也不要全局启用 `receive-pack`；该服务允许匿名推送，甚至删除远程引用。
...
----                 -------------         ------ ----
d----            2023/5/6     2:52                cloned_git_learning
